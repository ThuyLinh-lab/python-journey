...
# Gợi ý: Dùng // và %
print("Mỗi người được (chia nguyên):", 100//7)
print("Số viên kẹo dư là :",100%7)

# TODO 5 (Thử thách): Chuyển đổi 37 độ C sang Fahrenheit
# Công thức: F = C * 9/5 + 32
# In ra kết quả dạng: "37°C = ???°F"
print("37°C =", 37 * 9/5 + 32,"°F")